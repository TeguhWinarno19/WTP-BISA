                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-1">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Node MAKO</h5>
                                    <p class="card-text">Node yang akan mengukur konsumsi air yang meliputi Area Markas Komando, Masjid, Klinik, Kawasan Gardu induk, dan Area Lapangan Bola</p>
                                </div>                                
                            </div>
                        </div>
                        <!-- Area Chart -->
                                ...
                                <div class="card-body m-2">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $field2 ?> m<sup>3</sup></div>
                                        </div>
                                        <div class="col-auto">
