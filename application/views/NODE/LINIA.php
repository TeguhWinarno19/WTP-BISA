                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-1">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Node UTAS Lini A</h5>
                                    <p class="card-text">Node yang akan mengukur konsumsi air yang meliputi Kawasan Gedung Produksi Uang kertas LINI A, Limbah, Gedung Utilitas</p>
                                </div>                                
                            </div>
                        </div>
                        <!-- Area Chart -->
