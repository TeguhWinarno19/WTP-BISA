                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-1">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Node UTAS Lini B</h5>
                                    <p class="card-text">Node yang akan mengukur konsumsi air yang meliputi Gedung Produksi Uang kertas LINI B</p>
                                </div>                                
                            </div>
                        </div>
                        <!-- Area Chart -->
                        <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="card-body m-2">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $field4 ?> m<sup>3</sup> </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Water Meter Kawasan MAKO</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
